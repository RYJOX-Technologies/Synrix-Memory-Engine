...
1. Extract this package anywhere (e.g., `C:\synrix_free_tier_50k`)

2. In your Python script, add one line:

```python
import sys
sys.path.insert(0, r'C:\synrix_free_tier_50k')  # Change to your path
